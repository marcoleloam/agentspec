...
|----------|-------|----------|
| `BRAINSTORM_{FEATURE}.md` | 0 | `sdd/features/` |
| `DEFINE_{FEATURE}.md` | 1 | `sdd/features/` |
| `DESIGN_{FEATURE}.md` | 2 | `sdd/features/` |
| `BUILD_REPORT_{FEATURE}.md` | 3 | `sdd/reports/` |
| `SHIPPED_{DATE}.md` | 4 | `sdd/archive/{FEATURE}/` |
...
/define sdd/features/BRAINSTORM_USER_NOTIFICATIONS.md

# Phase 2: Create technical design
/design sdd/features/DEFINE_USER_NOTIFICATIONS.md

# Phase 3: Build the code
/build sdd/features/DESIGN_USER_NOTIFICATIONS.md

# Phase 4: Archive when complete
/ship sdd/features/DEFINE_USER_NOTIFICATIONS.md
```
...
| Contracts | `sdd/architecture/WORKFLOW_CONTRACTS.yaml` |
