---
name: "source-command-visual-explainer-generate-visual-plan"
...
# source-command-visual-explainer-generate-visual-plan

Use this skill when the user asks to run the migrated source command `visual-explainer-generate-visual-plan`.
