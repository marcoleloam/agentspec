---
name: "source-command-data-engineering-ai-pipeline"
description: "RAG/embedding pipeline scaffolding — delegates to ai-data-engineer agent"
---

# source-command-data-engineering-ai-pipeline

Use this skill when the user asks to run the migrated source command `data-engineering-ai-pipeline`.
