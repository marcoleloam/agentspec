---
name: "source-command-visual-explainer-fact-check"
description: "Verify the factual accuracy of a document against the actual codebase, correct inaccuracies in place"
---

# source-command-visual-explainer-fact-check

Use this skill when the user asks to run the migrated source command `visual-explainer-fact-check`.
