---
name: "source-command-data-engineering-lakehouse"
description: "Table format and catalog guidance — delegates to lakehouse-architect agent"
---

# source-command-data-engineering-lakehouse

Use this skill when the user asks to run the migrated source command `data-engineering-lakehouse`.
