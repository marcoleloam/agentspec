---
name: "source-command-review-review-slides"
description: "Review an AIDE slide deck for quality issues. Invokes aide-slide-reviewer for independent"
---

# source-command-review-review-slides

Use this skill when the user asks to run the migrated source command `review-review-slides`.
...
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/semana-palette.md (if deck is d1-d4)
