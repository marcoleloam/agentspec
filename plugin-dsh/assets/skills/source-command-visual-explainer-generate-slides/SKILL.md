---
name: "source-command-visual-explainer-generate-slides"
description: "Generate a stunning magazine-quality slide deck as a self-contained HTML page"
---

# source-command-visual-explainer-generate-slides

Use this skill when the user asks to run the migrated source command `visual-explainer-generate-slides`.
