...
**Usage:**
```bash
bash /Users/luanmorenomaciel/GitHub/agentspec/${CLAUDE_PLUGIN_ROOT}/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash /Users/luanmorenomaciel/GitHub/agentspec/${CLAUDE_PLUGIN_ROOT}/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
