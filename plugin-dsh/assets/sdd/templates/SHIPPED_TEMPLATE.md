...
> Feature entregue em {YYYY-MM-DD}
...
| Define Concluído | {YYYY-MM-DD} | {X dias} |
| Design Concluído | {YYYY-MM-DD} | {X dias} |
| Build Concluído | {YYYY-MM-DD} | {X dias} |
| **Entregue** | {YYYY-MM-DD} | **Total: {X dias}** |
...
|------------|-----------|
| {Componente 1} | {O que ele faz} |
| {Componente 2} | {O que ele faz} |
...
{O que você faria diferente no processo na próxima vez?}
...
{Onde o esclarecimento antecipado ajudou ou teria ajudado?}

- {Lição 1: Qual esclarecimento evitou retrabalho}
...
{Opcional: Note quaisquer desafios superados ou contribuições valiosas.}
