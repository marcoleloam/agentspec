...
<!-- Source: .claude/commands/workflow/brainstorm.md -->
...
- Agent: `${GROK_PLUGIN_ROOT}/agents/brainstorm-agent.md`
- Template: `${GROK_PLUGIN_ROOT}/sdd/templates/BRAINSTORM_TEMPLATE.md`
- Contracts: `${GROK_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `${GROK_PLUGIN_ROOT}/commands/define.md`
