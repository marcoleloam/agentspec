...
<!-- Source: .claude/commands/workflow/continue.md -->
...
- Related: `${GROK_PLUGIN_ROOT}/commands/iterate.md` (for SDD document changes)
- Related: `${GROK_PLUGIN_ROOT}/commands/build.md` (initial build)
