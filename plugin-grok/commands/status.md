...
<!-- Source: .claude/commands/core/status.md -->
...
```text
# Active features
list_dir(".claude/sdd/features/BRAINSTORM_*.md")
list_dir(".claude/sdd/features/DEFINE_*.md")
list_dir(".claude/sdd/features/DESIGN_*.md")

# Build reports
list_dir(".claude/sdd/reports/BUILD_REPORT_*.md")

# Recently shipped
list_dir(".claude/sdd/archive/*")
```
...
list_dir("**/pyproject.toml")
list_dir("**/package.json")
list_dir("**/dbt_project.yml")
list_dir("**/Dockerfile")
list_dir("**/*.tf")
list_dir("**/airflow.cfg")
list_dir("**/requirements.txt")
list_dir("**/Cargo.toml")
list_dir("**/go.mod")
list_dir("**/pom.xml")

# KB domain alignment
list_dir("${GROK_PLUGIN_ROOT}/kb/*/index.md")
```
