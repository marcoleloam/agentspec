...
<!-- Source: .claude/commands/workflow/create-pr.md -->
...
| `${GROK_PLUGIN_ROOT}/agents/**` | `refactor(agents):` |
| `${GROK_PLUGIN_ROOT}/kb/**` | `docs(kb):` |
| `.claude/sdd/**` | `docs(sdd):` |
...
| Scope | Applies To |
|-------|------------|
| `agents` | `${GROK_PLUGIN_ROOT}/agents/**` |
| `kb` | `${GROK_PLUGIN_ROOT}/kb/**` |
| `sdd` | `.claude/sdd/**` |
| `commands` | `${GROK_PLUGIN_ROOT}/commands/**` |
...
# Detected: Changes in ${GROK_PLUGIN_ROOT}/kb/
...
- Review Command: `${GROK_PLUGIN_ROOT}/commands/review.md`
- Code Reviewer Agent: `${GROK_PLUGIN_ROOT}/agents/code-reviewer.md`
- Workflow: `${GROK_PLUGIN_ROOT}/sdd/_index.md`
- Agents: `${GROK_PLUGIN_ROOT}/agents/`
