...
<!-- Source: .claude/commands/core/build-slides.md -->
...
Read these KB files:
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/slide-types.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/advanced-visuals.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
...
- SVG slides → ${GROK_PLUGIN_ROOT}/kb/aide-slides/advanced-visuals.md
- Card/stat slides → ${GROK_PLUGIN_ROOT}/kb/aide-slides/component-library.md
- All chunks → ${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- All chunks → ${GROK_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
- Chunk 1 only → ${GROK_PLUGIN_ROOT}/kb/aide-slides/template.md (for <head> and structure)
- Chunk 1 only → ${GROK_PLUGIN_ROOT}/kb/aide-slides/slide-engine.md (for JS)
...
Read KB files:
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/component-library.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/design-system.md
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
...
- Quality rules KB: `${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md`
