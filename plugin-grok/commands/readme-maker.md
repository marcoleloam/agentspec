...
<!-- Source: .claude/commands/core/readme-maker.md -->
...
list_dir("**/package.json")      # Node.js
list_dir("**/pyproject.toml")    # Python
list_dir("**/Cargo.toml")        # Rust
list_dir("**/go.mod")            # Go
list_dir("**/pom.xml")           # Java/Maven
list_dir("**/build.gradle")      # Java/Gradle

# Source code
list_dir("src/**/*")             # Main source
list_dir("lib/**/*")             # Library code
list_dir("tests/**/*")           # Test files
list_dir("docs/**/*")            # Documentation
```
