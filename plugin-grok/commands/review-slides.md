...
<!-- Source: .claude/commands/review/review-slides.md -->
...
- ${GROK_PLUGIN_ROOT}/kb/aide-slides/semana-palette.md (if deck is d1-d4)
...
- `aide-slide-reviewer` agent: `${GROK_PLUGIN_ROOT}/agents/aide-slide-reviewer.md`
- `aide-slide-fixer` agent: `${GROK_PLUGIN_ROOT}/agents/aide-slide-fixer.md`
