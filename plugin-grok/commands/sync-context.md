...
<!-- Source: .claude/commands/core/sync-context.md -->
...
list_dir("**/*.py")              # Python files
list_dir("**/*.ts")              # TypeScript files
list_dir("**/package.json")      # Node projects
list_dir("**/pyproject.toml")    # Python projects
list_dir("**/Dockerfile")        # Container configs
list_dir("**/*.tf")              # Terraform
```
...
list_dir("${GROK_PLUGIN_ROOT}/agents/*.md")
...
- **Agents**: Review ${GROK_PLUGIN_ROOT}/agents/
