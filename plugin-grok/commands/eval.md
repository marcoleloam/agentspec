...
Delegate to the **eval-agent** (`${GROK_PLUGIN_ROOT}/agents/eval-agent.md`). The agent:
...
- Agent: `${GROK_PLUGIN_ROOT}/agents/eval-agent.md`
- Runner: `scripts/eval_runner.py`, JEV client: `scripts/jev_client.py`
- Template: `${GROK_PLUGIN_ROOT}/sdd/templates/EVAL_REPORT_TEMPLATE.md`
- Contracts: `${GROK_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Previous: `${GROK_PLUGIN_ROOT}/commands/build.md` · Next: `${GROK_PLUGIN_ROOT}/commands/ship.md`
