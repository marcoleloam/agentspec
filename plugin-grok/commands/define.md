...
<!-- Source: .claude/commands/workflow/define.md -->
...
```markdown
read_file(${GROK_PLUGIN_ROOT}/sdd/templates/DEFINE_TEMPLATE.md)
...
`${GROK_PLUGIN_ROOT}/sdd/architecture/AGENT_SELECTION_RUBRIC.md` yourself, to the input (BRAINSTORM, notes or raw text).
...
If score < 12, use `ask_user_question` with specific options:
...
- Agent: `${GROK_PLUGIN_ROOT}/agents/define-agent.md`
- Multi-agent variant: `/define-m` (`${GROK_PLUGIN_ROOT}/commands/define-m.md`)
...
- Previous Phase: `${GROK_PLUGIN_ROOT}/commands/brainstorm.md` (optional)
- Next Phase: `${GROK_PLUGIN_ROOT}/commands/design.md`
