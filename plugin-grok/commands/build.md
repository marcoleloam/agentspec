...
<!-- Source: .claude/commands/workflow/build.md -->
...
- Agent: `${GROK_PLUGIN_ROOT}/agents/build-agent.md`
- Template: `${GROK_PLUGIN_ROOT}/sdd/templates/BUILD_REPORT_TEMPLATE.md`
- Contracts: `${GROK_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`
- Next Phase: `${GROK_PLUGIN_ROOT}/commands/ship.md`
