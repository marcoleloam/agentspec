...
<!-- Source: .claude/agents/cloud/ai-data-engineer-cloud.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/_______________  (cross-domain: loads relevant KB per task)
...
| `${GROK_PLUGIN_ROOT}/kb/` (project KB) | Pipeline work | Not data-related |
