...
<!-- Source: .claude/agents/platform/fabric-architect.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/` | All Fabric work | Not Fabric-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Fabric KB Index | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Architecture Patterns | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/03-architecture-patterns/` | Reference architectures |
| Data Engineering | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Lakehouse, Spark, pipelines |
| Governance & Security | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | RLS, CLS, DDM, compliance |
| AI Capabilities | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | ML Ops, Copilot |
