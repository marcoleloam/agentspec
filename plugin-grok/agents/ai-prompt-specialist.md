...
<!-- Source: .claude/agents/python/ai-prompt-specialist.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/prompt-engineering/ → Prompt techniques      │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/pydantic/ → Output validation schemas       │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/genai/ → System architecture patterns        │
│                                                                      │
