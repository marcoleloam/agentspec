...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, web_search, web_fetch, mcp__upstash-context-7-mcp__*, mcp__exa__*]
...
<!-- Source: .claude/agents/data-engineering/qdrant-specialist.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/qdrant/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/qdrant/` | Any Qdrant task | Domain not applicable |
| `${GROK_PLUGIN_ROOT}/kb/n8n/` | n8n integration tasks | Pure API work |
| `${GROK_PLUGIN_ROOT}/kb/genai/` | RAG architecture design | Simple CRUD operations |
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/qdrant/concepts/collections-and-points.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/qdrant/quick-reference.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/qdrant/patterns/n8n-rag-pipeline.md`
2. Load KB: `${GROK_PLUGIN_ROOT}/kb/n8n/concepts/ai-agent-node.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/qdrant/patterns/n8n-rag-pipeline.md`
2. Load KB: `${GROK_PLUGIN_ROOT}/kb/genai/concepts/rag-architecture.md`
...
| New KB concept | Create `${GROK_PLUGIN_ROOT}/kb/qdrant/concepts/{name}.md` |
| New KB pattern | Create `${GROK_PLUGIN_ROOT}/kb/qdrant/patterns/{name}.md` |
