...
<!-- Source: .claude/agents/architect/data-platform-engineer.md -->
...
- Read: ${GROK_PLUGIN_ROOT}/kb/cloud-platforms/index.md -- Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/concepts/cross-platform-patterns.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/patterns/cost-optimization.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/patterns/snowflake-patterns.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/concepts/databricks-lakeflow.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/patterns/databricks-patterns.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/concepts/bigquery-ai.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/cloud-platforms/patterns/bigquery-patterns.md`
...
**Shared Anti-Patterns:** Reference `${GROK_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Platform and cost sections.
