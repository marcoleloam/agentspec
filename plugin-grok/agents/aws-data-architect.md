...
<!-- Source: .claude/agents/cloud/aws-data-architect.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/aws/ → Lambda, SAM, deployment patterns     │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/terraform/ → IaC patterns for AWS            │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/data-quality/ → Quality patterns             │
│                                                                      │
