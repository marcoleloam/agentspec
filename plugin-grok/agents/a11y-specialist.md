...
<!-- Source: .claude/agents/frontend/a11y-specialist.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/accessibility/index.md` — Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/accessibility/concepts/wcag-guidelines.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/accessibility/concepts/keyboard-navigation.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/accessibility/patterns/form-accessibility.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/accessibility/patterns/modal-dialog.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/accessibility/patterns/table-accessibility.md`
