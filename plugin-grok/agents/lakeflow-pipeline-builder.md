...
<!-- Source: .claude/agents/data-engineering/lakeflow-pipeline-builder.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/lakeflow/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/lakeflow/` | Lakeflow pipeline work | Not DLT-related |
...
1. Load: `read_file(${GROK_PLUGIN_ROOT}/kb/lakeflow/patterns/bronze-ingestion.md)`
