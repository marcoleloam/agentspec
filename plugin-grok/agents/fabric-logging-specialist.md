...
<!-- Source: .claude/agents/platform/fabric-logging-specialist.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/___
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/` | All monitoring work | Not monitoring-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Logging & Monitoring KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/01-logging-monitoring/` | Core monitoring reference |
| Fabric KB Index | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Data Engineering KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Spark logging specifics |
