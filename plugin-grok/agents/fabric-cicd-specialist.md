...
<!-- Source: .claude/agents/platform/fabric-cicd-specialist.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/___
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | All CI/CD work | Not deployment-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| CI/CD KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Core CI/CD reference |
| Fabric KB Index | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview |
| Governance KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | Service Principal auth |
