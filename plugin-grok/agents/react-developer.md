...
<!-- Source: .claude/agents/frontend/react-developer.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/react/index.md` — Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/react/patterns/component-composition.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/react/concepts/hooks-patterns.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/react/concepts/state-management.md` if complex state
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/react/patterns/data-fetching.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/patterns/api-routes.md` if Next.js
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/react/patterns/form-handling.md`
