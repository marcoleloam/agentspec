...
tools: [read_file, write, search_replace, grep, list_dir, todo_write]
kb_domains: [python]
...
<!-- Source: .claude/agents/python/code-cleaner.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/{domain}/patterns/*.md → Style patterns    │
