...
<!-- Source: .claude/agents/frontend/ux-designer.md -->
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/frontend-patterns/concepts/project-structure.md` for existing patterns
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/frontend-patterns/patterns/auth-flow.md` for auth-aware navigation
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/design-systems/concepts/component-api.md`
