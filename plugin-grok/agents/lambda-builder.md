...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, mcp__exa__get_code_context_exa, mcp__upstash-context-7-mcp__*]
...
<!-- Source: .claude/agents/cloud/lambda-builder.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/aws/lambda/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/aws/lambda/` | Lambda patterns | Simple updates |
...
**Sources:**
- KB: ${GROK_PLUGIN_ROOT}/kb/aws/lambda/patterns/{pattern}.md
