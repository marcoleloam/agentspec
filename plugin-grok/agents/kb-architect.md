...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, web_search, web_fetch]
tier: T2
kb_domains: []
...
<!-- Source: .claude/agents/architect/kb-architect.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/_index.yaml → KB manifest                   │
│     └─ Glob: ${GROK_PLUGIN_ROOT}/kb/{domain}/**/*.md → Existing content         │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/_templates/ → File templates                │
│                                                                      │
...
```markdown
**KB Domain Created:** `${GROK_PLUGIN_ROOT}/kb/{domain}/`
