...
<!-- Source: .claude/agents/architect/lakehouse-architect.md -->
...
- Read: ${GROK_PLUGIN_ROOT}/kb/lakehouse/index.md -- Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/concepts/iceberg-v3.md` and `${GROK_PLUGIN_ROOT}/kb/lakehouse/concepts/delta-lake.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/patterns/iceberg-operations.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/patterns/delta-operations.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/concepts/catalog-wars.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/patterns/catalog-setup.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/lakehouse/patterns/migration-to-open-formats.md`
...
**Shared Anti-Patterns:** Reference `${GROK_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Storage and format sections.
