...
<!-- Source: .claude/agents/platform/fabric-pipeline-developer.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/___
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | All pipeline work | Not pipeline-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| Data Engineering KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Core pipeline reference |
| Architecture Patterns KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/03-architecture-patterns/` | Pipeline architecture |
