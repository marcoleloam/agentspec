...
<!-- Source: .claude/agents/python/python-developer.md -->
...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/python/ → Python patterns and idioms         │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/pydantic/ → Data validation patterns         │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/testing/ → pytest patterns                   │
│                                                                      │
│  2. CODEBASE ANALYSIS                                               │
