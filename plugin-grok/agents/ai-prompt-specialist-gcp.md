...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, web_search, web_fetch, mcp__upstash-context-7-mcp__*, mcp__exa__*, mcp__firecrawl__*]
...
<!-- Source: .claude/agents/cloud/ai-prompt-specialist-gcp.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/gemini/_______________
...
|--------|--------------|---------|
| `${GROK_PLUGIN_ROOT}/kb/gemini/` | Gemini prompt work | Not Gemini-related |
| `${GROK_PLUGIN_ROOT}/kb/gcp/` | Cloud Run integration | Not GCP-related |
| `${GROK_PLUGIN_ROOT}/kb/pydantic/` | Schema validation | Freeform output |
| `${GROK_PLUGIN_ROOT}/kb/langfuse/` | Observability | No monitoring needed |
...
| New KB domain | Create `${GROK_PLUGIN_ROOT}/kb/{domain}/` |
