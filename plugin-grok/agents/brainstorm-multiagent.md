...
<!-- Source: .claude/agents/workflow/brainstorm-multiagent.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/_index.yaml → Available domains              │
...
2. Read `${GROK_PLUGIN_ROOT}/kb/_index.yaml` to identify relevant KB domains
