...
tools: [read_file, write, search_replace, run_terminal_command, grep, list_dir, todo_write, web_search, web_fetch, spawn_subagent, mcp__exa__get_code_context_exa]
...
<!-- Source: .claude/agents/data-engineering/lakeflow-expert.md -->
...
| `${GROK_PLUGIN_ROOT}/kb/lakeflow/` | DLT work | Not Lakeflow-related |
...
Reference: `${GROK_PLUGIN_ROOT}/kb/lakeflow/08-operations/limitations.md`
