...
tools: [read_file, write, search_replace, grep, list_dir, todo_write, web_search, mcp__upstash-context-7-mcp__*, mcp__exa__*]
...
<!-- Source: .claude/agents/python/llm-specialist.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/prompt-engineering/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/prompt-engineering/` | Prompt work | Not prompt-related |
...
```text
${GROK_PLUGIN_ROOT}/kb/prompt-engineering/
