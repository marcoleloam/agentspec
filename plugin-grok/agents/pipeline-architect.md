...
<!-- Source: .claude/agents/architect/pipeline-architect.md -->
...
**Lightweight Index:**
- Read: ${GROK_PLUGIN_ROOT}/kb/airflow/index.md -- Scan headings

**On-Demand Loading:**
1. Read specific pattern/concept for the orchestrator in use
2. If comparing orchestrators: Read ${GROK_PLUGIN_ROOT}/kb/airflow/concepts/orchestrator-comparison.md
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/airflow/concepts/dag-design.md` for design principles
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/airflow/concepts/operators.md` for catalog
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/airflow/patterns/dynamic-task-mapping.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/airflow/patterns/error-handling.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/airflow/patterns/sensors-triggers.md`
...
**Shared Anti-Patterns:** Reference `${GROK_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Pipeline section.
