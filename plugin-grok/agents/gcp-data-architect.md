...
<!-- Source: .claude/agents/cloud/gcp-data-architect.md -->
...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/gcp/ → Cloud Run, Pub/Sub, GCS, BigQuery    │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/terraform/ → Terraform GCP modules           │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/cloud-platforms/ → BigQuery AI patterns      │
│                                                                      │
