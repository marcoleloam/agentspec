...
<!-- Source: .claude/agents/test/data-contracts-engineer.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/data-quality/index.md` -- Scan contract-related headings
- DO NOT read `patterns/*` or `concepts/*` unless task matches

**On-Demand Loading:**
1. Read `${GROK_PLUGIN_ROOT}/kb/data-quality/concepts/data-contracts.md` for ODCS spec
2. Read `${GROK_PLUGIN_ROOT}/kb/data-quality/patterns/data-contract-authoring.md` for patterns
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/data-quality/concepts/data-contracts.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/data-quality/patterns/data-contract-authoring.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/data-modeling/concepts/schema-evolution.md`
...
**Shared Anti-Patterns:** Reference `${GROK_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- Contract and governance sections.
