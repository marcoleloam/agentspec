...
<!-- Source: .claude/agents/architect/genai-architect.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/genai/ → Multi-agent, RAG, state machines   │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/prompt-engineering/ → Prompt patterns        │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/ → Data pipeline AI      │
│                                                                      │
