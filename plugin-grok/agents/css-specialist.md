...
<!-- Source: .claude/agents/frontend/css-specialist.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/tailwind-css/index.md` — Scan topic headings
- Read: `${GROK_PLUGIN_ROOT}/kb/design-systems/index.md` — Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/tailwind-css/patterns/component-styling.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/tailwind-css/concepts/design-tokens.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/design-systems/concepts/token-architecture.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/tailwind-css/patterns/dark-mode.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/design-systems/patterns/theme-switching.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/tailwind-css/concepts/responsive-design.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/design-systems/patterns/variant-pattern.md`
