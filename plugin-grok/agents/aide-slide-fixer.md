...
<!-- Source: .claude/agents/domain/aide-slide-fixer.md -->
...
│                                                                      │
│  2. KB VERIFICATION                                                  │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md → Confirm fix  │
...
- `${GROK_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md` — Correct patterns for each rule
- `${GROK_PLUGIN_ROOT}/kb/aide-slides/component-library.md` — Correct CSS classes and structure
