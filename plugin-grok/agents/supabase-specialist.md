...
<!-- Source: .claude/agents/cloud/supabase-specialist.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/supabase/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/supabase/` | Any Supabase task | Domain not applicable |
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/concepts/pgvector-fundamentals.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/concepts/rls-policies.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/concepts/edge-functions.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/concepts/rls-policies.md` (auth context)
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/patterns/rag-vector-store.md` (if vector schema)
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/supabase/` (realtime section)
...
| New KB domain | Create `${GROK_PLUGIN_ROOT}/kb/supabase/` if not exists |
| New patterns | Add to `${GROK_PLUGIN_ROOT}/kb/supabase/patterns/` |
