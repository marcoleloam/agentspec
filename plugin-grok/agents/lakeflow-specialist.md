...
<!-- Source: .claude/agents/data-engineering/lakeflow-specialist.md -->
...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/lakeflow/ → DLT pipelines, expectations     │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/lakehouse/ → Delta Lake, catalog patterns    │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/spark/ → Spark SQL, DataFrame patterns       │
│                                                                      │
