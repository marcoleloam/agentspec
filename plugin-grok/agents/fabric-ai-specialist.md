...
<!-- Source: .claude/agents/platform/fabric-ai-specialist.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/___
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | All AI work | Not AI-related |
...
| Source | Path | Purpose |
|--------|------|---------|
| AI Capabilities KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/08-ai-capabilities/` | Core AI reference |
| Data Engineering KB | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/02-data-engineering/` | Spark/notebook patterns |
