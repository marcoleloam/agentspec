...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, web_search, mcp__upstash-context-7-mcp__*, mcp__exa__*]
color: red
stop_conditions:
...
<!-- Source: .claude/agents/platform/fabric-security-specialist.md -->
...
VALIDATION
+-- KB: ${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | All security tasks | Not security-related |
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/04-data-warehouse/` | RLS/CLS/DDM in warehouse | Lakehouse-only task |
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/` | Service Principal auth | No API/automation involved |
| `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Secure CI/CD patterns | No deployment involved |
...
```text
${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/
...
| Source | Path | Purpose |
|--------|------|---------|
| Governance & Security | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` | Primary security KB (RLS, CLS, DDM, auth, encryption) |
| Data Warehouse | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/04-data-warehouse/` | Warehouse-level security features |
| APIs & SDKs | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/` | Service Principal authentication |
| CI/CD & Automation | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/07-cicd-automation/` | Secure deployment patterns |
| Fabric KB Index | `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/index.md` | Domain overview and navigation |
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/security-overview.md`
...
**Process:**
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/security-overview.md` + `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/05-apis-sdks/`
...
| New KB security content | Add to `${GROK_PLUGIN_ROOT}/kb/microsoft-fabric/06-governance-security/` |
