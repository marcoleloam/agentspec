...
<!-- Source: .claude/agents/dev/kb-evolution-agent.md -->
...
│                                                                      │
│  1. KB MANIFEST                                                     │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/_index.yaml → Domain registry               │
│     └─ Glob: ${GROK_PLUGIN_ROOT}/kb/{domain}/**/*.md → Current content          │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/_templates/ → File format templates         │
│                                                                      │
...
5. **Update `log.md`** — Append entry to `${GROK_PLUGIN_ROOT}/kb/{domain}/log.md` with:
...
6. **Update `log.md`** — Append lint entry to `${GROK_PLUGIN_ROOT}/kb/{domain}/log.md`
