...
<!-- Source: .claude/agents/cloud/ci-cd-specialist.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/devops/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/devops/` | DevOps patterns | Simple updates |
...
**Sources:**
- KB: ${GROK_PLUGIN_ROOT}/kb/devops/patterns/{pattern}.md
