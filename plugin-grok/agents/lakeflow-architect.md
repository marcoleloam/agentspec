...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, mcp__upstash-context-7-mcp__*, mcp__exa__get_code_context_exa]
...
<!-- Source: .claude/agents/data-engineering/lakeflow-architect.md -->
...
| `${GROK_PLUGIN_ROOT}/kb/lakeflow/` | Pipeline architecture | Not DLT-related |
...
1. Load KB: `${GROK_PLUGIN_ROOT}/kb/lakeflow/quick-reference.md`
