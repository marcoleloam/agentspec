...
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write]
...
<!-- Source: .claude/agents/data-engineering/ai-data-engineer.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/index.md` -- Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/rag-pipelines.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/rag-pipeline-implementation.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/vector-databases.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/vector-db-operations.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/feature-stores.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/feature-engineering.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/patterns/text-to-sql.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/ai-data-engineering/concepts/embedding-pipelines.md`
...
**Shared Anti-Patterns:** Reference `${GROK_PLUGIN_ROOT}/kb/shared/anti-patterns.md` -- AI and embedding sections.
