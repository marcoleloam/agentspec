...
tools: [read_file, write, search_replace, run_terminal_command, grep, list_dir, todo_write, web_search, spawn_subagent, mcp__upstash-context-7-mcp__*, mcp__exa__*]
...
<!-- Source: .claude/agents/data-engineering/spark-specialist.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/spark/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/spark/` | Spark-related work | Not Spark-related |
