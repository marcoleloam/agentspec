...
tools: [read_file, write, search_replace, run_terminal_command, todo_write, mcp__upstash-context-7-mcp__*, mcp__exa__*]
...
<!-- Source: .claude/agents/cloud/aws-deployer.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/aws/deployment/_______________
...
| `${GROK_PLUGIN_ROOT}/kb/aws/deployment/` | Deployment patterns | Simple S3 operations |
...
**Sources:**
- KB: ${GROK_PLUGIN_ROOT}/kb/aws/deployment/patterns/{pattern}.md
