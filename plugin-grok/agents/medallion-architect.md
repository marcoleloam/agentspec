...
<!-- Source: .claude/agents/architect/medallion-architect.md -->
...
│                                                                      │
│  1. KB CHECK                                                        │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/medallion/ → Layer design patterns           │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/data-modeling/ → Schema patterns             │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/lakehouse/ → Storage format patterns         │
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/data-quality/ → Quality progression          │
│                                                                      │
