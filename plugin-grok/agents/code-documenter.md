...
tools: [read_file, write, search_replace, list_dir, grep, run_terminal_command, todo_write]
kb_domains: [python]
...
<!-- Source: .claude/agents/python/code-documenter.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/{domain}/docs/*.md → Doc templates          │
