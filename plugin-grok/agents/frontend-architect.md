...
<!-- Source: .claude/agents/frontend/frontend-architect.md -->
...
- Read: `${GROK_PLUGIN_ROOT}/kb/nextjs/index.md` — Scan topic headings
- Read: `${GROK_PLUGIN_ROOT}/kb/frontend-patterns/index.md` — Scan topic headings
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/concepts/rendering-strategies.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/frontend-patterns/concepts/performance.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/concepts/caching.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/frontend-patterns/concepts/project-structure.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/concepts/caching.md`
...
**Process:**
1. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/patterns/api-routes.md`
2. Read `${GROK_PLUGIN_ROOT}/kb/nextjs/concepts/middleware.md`
