...
<!-- Source: .claude/agents/data-engineering/airflow-specialist.md -->
...
VALIDATION
├─ KB: ${GROK_PLUGIN_ROOT}/kb/_______________  (cross-domain: no dedicated KB, uses project KB)
...
| `${GROK_PLUGIN_ROOT}/kb/` | Domain-related work | Not pipeline-related |
...
|--------|----------|---------|
| `${GROK_PLUGIN_ROOT}/kb/` (if applicable) | Primary | Project-specific patterns and conventions |
