...
tools: [read_file, write, search_replace, run_terminal_command, grep, list_dir, todo_write, web_search, mcp__upstash-context-7-mcp__*, mcp__exa__*]
...
<!-- Source: .claude/agents/data-engineering/spark-streaming-architect.md -->
...
| `${GROK_PLUGIN_ROOT}/kb/spark/` | Streaming work | Not streaming-related |
