...
tools: [read_file, write, search_replace, grep, list_dir, web_search, todo_write, web_fetch]
tier: T2
kb_domains: []
...
<!-- Source: .claude/agents/architect/the-planner.md -->
...
│     └─ Read: ${GROK_PLUGIN_ROOT}/kb/{domain}/architecture/*.md → Patterns       │
