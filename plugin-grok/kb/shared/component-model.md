...
Templates are the fifth, narrower piece: an artifact's required shape, owned in one place (`${GROK_PLUGIN_ROOT}/sdd/templates/`, `${GROK_PLUGIN_ROOT}/kb/_templates/`) and referenced by skills — never re-inlined.
