...
| **Domínios KB** | {Liste os domínios de ${GROK_PLUGIN_ROOT}/kb/ relevantes para esta feature} | {Quais padrões consultar} |
...
- **Domínios KB** → Fase de Design puxa os padrões corretos de `${GROK_PLUGIN_ROOT}/kb/`
