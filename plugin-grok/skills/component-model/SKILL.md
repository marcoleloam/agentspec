...
`${GROK_PLUGIN_ROOT}/kb/shared/component-model.md`; this skill applies that model, it does not
restate it.
...
1. **Read the canonical model.** Open `${GROK_PLUGIN_ROOT}/kb/shared/component-model.md` — the four
...
4. **Route to the authoring resource.**
   ...
   | Template | own it in the template directories (`${GROK_PLUGIN_ROOT}/sdd/templates/`, `${GROK_PLUGIN_ROOT}/kb/_templates/`) and have skills reference it |
...
|---|---|
| `${GROK_PLUGIN_ROOT}/kb/shared/component-model.md` | Always — the source of truth for layer definitions, the placement table, and anti-pattern rationale |
