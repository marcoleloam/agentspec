...
Phase templates are available at `${GROK_PLUGIN_ROOT}/sdd/templates/`:
...
Phase transition rules are defined in `${GROK_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml`.
