...
<!-- =========================================================================
     ...
     Source of truth: ${GROK_PLUGIN_ROOT}/agents/*.md frontmatter
...
| `kb-architect` | T2 | sonnet | — | `user`, `kb-evolution-agent` |
...
| `supabase-specialist` | T3 | opus | `ai-data-engineering`, `data-modeling` | `gcp-data-architect`, `aws-data-architect`, `user` |
...
| `n8n-specialist` | T3 | sonnet | `n8n`, `streaming`, `sql-patterns` | `schema-designer`, `spark-engineer`, `dbt-specialist`, `ci-cd-specialist` |
...
| Agent | Tier | Model | KB Domains | Escalates To |
|-------|------|-------|-----------|--------------|
| `codebase-explorer` | T2 | sonnet | — | `python-developer`, `solution-architect` |
| `kb-evolution-agent` | T2 | sonnet | `prompt-engineering`, `genai` | `kb-architect` |
| `meeting-analyst` | T2 | sonnet | — | `solution-architect`, `pipeline-architect` |
...
| `design-systems` | `css-specialist`, `ux-designer` |
| `frontend-patterns` | `frontend-architect`, `ux-designer` |
| `gcp` | `ai-data-engineer-cloud`, `ai-data-engineer-gcp`, `ai-prompt-specialist-gcp`, `gcp-data-architect` |
| `genai` | `ai-prompt-specialist`, `ai-prompt-specialist-gcp`, `genai-architect`, `kb-evolution-agent`, `llm-specialist`, `qdrant-specialist` |
...
| `n8n` | `n8n-specialist` |
| `nextjs` | `frontend-architect`, `react-developer` |
| `prompt-engineering` | `ai-prompt-specialist`, `ai-prompt-specialist-gcp`, `genai-architect`, `kb-evolution-agent`, `llm-specialist` |
...
| `sql-patterns` | `airflow-specialist`, `code-reviewer`, `dbt-specialist`, `n8n-specialist`, `schema-designer`, `spark-engineer`, `spark-specialist`, `spark-troubleshooter`, `sql-optimizer`, `streaming-engineer` |
...
- **`a11y-specialist`** — Accessibility specialist for WCAG compliance, aria attributes, keyboard navigation, and screen reader support.
...
- **`aide-slide-builder`** — Builds complete HTML slide decks for the Formacao AI Data Engineer using the AIDE design system.
- **`aide-slide-fixer`** — Surgical correction agent for AIDE slide decks. Reads review reports from aide-slide-reviewer
- **`aide-slide-planner`** — Content architecture agent for AIDE slide decks. Decomposes lesson content into a structured
- **`aide-slide-reviewer`** — Independent quality reviewer for AIDE slide decks. READ-ONLY — validates HTML presentations
...
- **`brainstorm-multiagent`** — Multi-agent brainstorm orchestrator for complex cross-domain ideas (Phase 0 experimental).
...
- **`css-specialist`** — Tailwind CSS and design system specialist for responsive design, animations, dark mode, and visual consistency.
...
- **`frontend-architect`** — Frontend system architect for Next.js application design, performance optimization, and deployment strategy.
...
- **`kb-evolution-agent`** — KB evolution specialist for ingesting updates from Context7 MCP and
...
- **`n8n-specialist`** — n8n workflow automation specialist for workflow design, node configuration, API integrations,
...
- **`react-developer`** — React and Next.js component specialist for hooks, Server Components, state management, and rendering patterns.
...
- **`shopagent-builder`** — ShopAgent domain specialist for e-commerce multi-agent systems. Builds ShopAgent components by day:
...
- **`ux-designer`** — User experience specialist for user flows, information architecture, wireframes, and usability patterns.
