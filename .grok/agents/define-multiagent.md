...
tier: T2
tools: [read_file, write, search_replace, grep, list_dir, run_terminal_command, todo_write, ask_user_question, Agent]
kb_domains: []
...
<!-- Source: .claude/agents/workflow/define-multiagent.md -->
