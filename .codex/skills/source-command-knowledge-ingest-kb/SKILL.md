---
name: "source-command-knowledge-ingest-kb"
description: "Update a KB domain with latest docs from Context7 MCP"
---

# source-command-knowledge-ingest-kb

Use this skill when the user asks to run the migrated source command `knowledge-ingest-kb`.
