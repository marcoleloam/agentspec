---
name: "source-command-data-engineering-migrate"
description: "Legacy ETL migration — delegates to dbt-specialist and spark-engineer agents"
---

# source-command-data-engineering-migrate

Use this skill when the user asks to run the migrated source command `data-engineering-migrate`.
