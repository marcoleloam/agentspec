...
`.claude/sdd/architecture/AGENT_SELECTION_RUBRIC.md` yourself, to the input (BRAINSTORM, notes or raw text).
...
4. Optional second opinion: when `JEV_SECOND_OPINION=1` is set, also run
   ...
   `docs/concepts/jev-agent-selection.md`, `"phase": "define"`) and record its variant and specialists
