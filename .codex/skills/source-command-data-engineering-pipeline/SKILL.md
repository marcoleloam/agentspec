---
name: "source-command-data-engineering-pipeline"
description: "DAG/pipeline scaffolding — delegates to pipeline-architect agent"
---

# source-command-data-engineering-pipeline

Use this skill when the user asks to run the migrated source command `data-engineering-pipeline`.
