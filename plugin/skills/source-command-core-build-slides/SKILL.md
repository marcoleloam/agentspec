---
name: "source-command-core-build-slides"
description: "Full pipeline for building AIDE slide decks: plan → build (chunked) → review → fix → assemble."
---

# source-command-core-build-slides

Use this skill when the user asks to run the migrated source command `core-build-slides`.
...
Read these KB files:
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/slide-types.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/advanced-visuals.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
...
- SVG slides → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/advanced-visuals.md
- Card/stat slides → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/component-library.md
- All chunks → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- All chunks → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
- Chunk 1 only → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/template.md (for <head> and structure)
- Chunk 1 only → ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/slide-engine.md (for JS)
...
Read KB files:
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/component-library.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/design-system.md
- ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/{palette_file}
