---
name: "source-command-visual-explainer-diff-review"
description: "Generate a visual HTML diff review — before/after architecture comparison with code review analysis"
---

# source-command-visual-explainer-diff-review

Use this skill when the user asks to run the migrated source command `visual-explainer-diff-review`.
