---
name: "source-command-visual-explainer-project-recap"
...
# source-command-visual-explainer-project-recap

Use this skill when the user asks to run the migrated source command `visual-explainer-project-recap`.
