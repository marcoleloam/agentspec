---
name: "source-command-workflow-design-m"
description: "Multi-agent architecture design with specialist validation (Phase 2 enhanced)"
---

# source-command-workflow-design-m

Use this skill when the user asks to run the migrated source command `workflow-design-m`.
