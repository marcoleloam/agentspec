---
name: "source-command-visual-explainer-generate-web-diagram"
description: "Generate a beautiful standalone HTML diagram and open it in the browser"
---

# source-command-visual-explainer-generate-web-diagram

Use this skill when the user asks to run the migrated source command `visual-explainer-generate-web-diagram`.
