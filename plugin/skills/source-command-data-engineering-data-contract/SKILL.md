---
name: "source-command-data-engineering-data-contract"
description: "Data contract authoring (ODCS) — delegates to data-contracts-engineer agent"
---

# source-command-data-engineering-data-contract

Use this skill when the user asks to run the migrated source command `data-engineering-data-contract`.
