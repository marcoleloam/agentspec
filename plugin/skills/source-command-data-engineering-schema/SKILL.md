---
name: "source-command-data-engineering-schema"
description: "Interactive schema design — delegates to schema-designer agent"
---

# source-command-data-engineering-schema

Use this skill when the user asks to run the migrated source command `data-engineering-schema`.
