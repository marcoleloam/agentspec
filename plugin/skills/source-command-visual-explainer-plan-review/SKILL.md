---
name: "source-command-visual-explainer-plan-review"
description: "Generate a visual HTML plan review — current codebase state vs. proposed implementation plan"
---

# source-command-visual-explainer-plan-review

Use this skill when the user asks to run the migrated source command `visual-explainer-plan-review`.
