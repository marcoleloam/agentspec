---
name: "source-command-visual-explainer-share"
description: "Run the AgentSpec share command"
---

# source-command-visual-explainer-share

Use this skill when the user asks to run the migrated source command `visual-explainer-share`.
...
```bash
bash /Users/luanmorenomaciel/GitHub/agentspec/${CLAUDE_PLUGIN_ROOT}/skills/visual-explainer/scripts/share.sh <file>
```
