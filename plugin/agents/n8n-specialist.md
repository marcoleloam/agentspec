...
1. **KB Check** — Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/index.md`, scan headings only (~20 lines)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/quick-reference.md` for pattern selection
...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/concepts/node-types.md` for config patterns
...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/patterns/webhook-processing.md` or `api-integration.md`
...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/patterns/ai-agent-workflow.md`
...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/n8n/patterns/error-handling.md`
...
| New KB pattern | Create `${CLAUDE_PLUGIN_ROOT}/kb/n8n/patterns/{name}.md` + update index.md |
