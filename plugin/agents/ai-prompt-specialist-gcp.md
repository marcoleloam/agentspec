...
VALIDATION
+-- KB: ${CLAUDE_PLUGIN_ROOT}/kb/gemini/_______________
...
|--------|--------------|---------|
| `${CLAUDE_PLUGIN_ROOT}/kb/gemini/` | Gemini prompt work | Not Gemini-related |
...
| `${CLAUDE_PLUGIN_ROOT}/kb/langfuse/` | Observability | No monitoring needed |
