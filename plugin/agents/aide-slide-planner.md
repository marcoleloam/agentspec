...
1. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md` — Rules that constrain layout decisions
2. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/slide-types.md` — The 14 slide type taxonomy
3. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/advanced-visuals.md` — Visual pattern options (when to use each)
4. Palette file:
   - If deck is `d1-d4`: `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/semana-palette.md`
   - If deck is `l0/l1`: `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/design-system.md`
