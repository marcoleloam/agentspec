...
VALIDATION
+-- KB: ${CLAUDE_PLUGIN_ROOT}/kb/qdrant/_______________
...
| `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/` | Any Qdrant task | Domain not applicable |
| `${CLAUDE_PLUGIN_ROOT}/kb/n8n/` | n8n integration tasks | Pure API work |
...
**Process:**
1. Load KB: `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/concepts/collections-and-points.md`
...
**Process:**
1. Load KB: `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/quick-reference.md`
...
**Process:**
1. Load KB: `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/patterns/n8n-rag-pipeline.md`
2. Load KB: `${CLAUDE_PLUGIN_ROOT}/kb/n8n/concepts/ai-agent-node.md`
...
| New KB concept | Create `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/concepts/{name}.md` |
| New KB pattern | Create `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/patterns/{name}.md` |
