...
│                                                                      │
│  2. KB VERIFICATION                                                  │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md → Confirm fix  │
...
- `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md` — Correct patterns for each rule
- `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/component-library.md` — Correct CSS classes and structure
