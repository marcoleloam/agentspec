...
1. Read `${CLAUDE_PLUGIN_ROOT}/kb/{domain}/{specific-file}.md` for relevant pattern
...
| New KB domain | Add to kb_domains frontmatter + create ${CLAUDE_PLUGIN_ROOT}/kb/{domain}/ |
