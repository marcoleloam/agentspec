...
1. `${CLAUDE_PLUGIN_ROOT}/kb/shadowtraffic/patterns/ecommerce-postgres.md` — Full config for customers+products+orders→Postgres, reviews→JSONL
2. `${CLAUDE_PLUGIN_ROOT}/kb/pydantic/concepts/base-model.md` — Pydantic models for e-commerce entities
3. `${CLAUDE_PLUGIN_ROOT}/kb/shadowtraffic/concepts/functions.md` — _gen functions (uuid, lookup, faker)

### Day 2: RAG + Ledger
4. `${CLAUDE_PLUGIN_ROOT}/kb/llamaindex/patterns/jsonl-to-qdrant.md` — **KEY**: JSONL→FastEmbed→Qdrant pipeline
5. `${CLAUDE_PLUGIN_ROOT}/kb/qdrant/quick-reference.md` — Collection config, search API
6. `${CLAUDE_PLUGIN_ROOT}/kb/supabase/quick-reference.md` — SQL queries via MCP

### Day 3: Agent + Chainlit
7. `${CLAUDE_PLUGIN_ROOT}/kb/langchain/patterns/react-agent-dual-tools.md` — **KEY**: Dual-tool agent (SQL vs semantic)
8. `${CLAUDE_PLUGIN_ROOT}/kb/chainlit/patterns/langchain-integration.md` — **KEY**: Streaming chat with step visibility
9. `${CLAUDE_PLUGIN_ROOT}/kb/langchain/concepts/tools.md` — @tool definitions with routing docstrings

### Day 4: Multi-Agent + Eval + Cloud
10. `${CLAUDE_PLUGIN_ROOT}/kb/crewai/concepts/agents.md` — Agent roles, goals, backstories
11. `${CLAUDE_PLUGIN_ROOT}/kb/crewai/concepts/crews.md` — Crew composition
12. `${CLAUDE_PLUGIN_ROOT}/kb/deepeval/patterns/agent-evaluation.md` — **KEY**: Evaluate tool routing + answer quality
13. `${CLAUDE_PLUGIN_ROOT}/kb/langfuse/patterns/python-sdk-integration.md` — Observability traces
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/shadowtraffic/patterns/ecommerce-postgres.md`
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/pydantic/concepts/base-model.md`
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/llamaindex/patterns/jsonl-to-qdrant.md`
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/langchain/patterns/react-agent-dual-tools.md`
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/chainlit/patterns/langchain-integration.md`
**Output:** Chainlit app with streaming + tool step visibility

### Capability 6: CrewAI Crew (Day 4)

**When:** User needs multi-agent crew
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/crewai/concepts/agents.md`, `${CLAUDE_PLUGIN_ROOT}/kb/crewai/concepts/crews.md`
...
**KB:** `${CLAUDE_PLUGIN_ROOT}/kb/deepeval/patterns/agent-evaluation.md`
