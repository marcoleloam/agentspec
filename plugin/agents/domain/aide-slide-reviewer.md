...
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md → ALL rules    │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/component-library.md → Classes  │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/design-system.md → Variables    │
│     └─ Read: ${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/semana-palette.md → If d1-d4    │
│                                                                      │
...
1. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/quality-rules.md` — Your primary reference. Every check maps to a rule here.
2. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/component-library.md` — Correct CSS class usage and component structure.
3. `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/design-system.md` — Color palette, typography stack, CSS variables.
4. If deck filename starts with `d1-d4`: `${CLAUDE_PLUGIN_ROOT}/kb/aide-slides/semana-palette.md` — Semana palette overrides.
