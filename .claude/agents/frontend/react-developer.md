...
- Read: `.claude/kb/react/index.md` — Scan topic headings
- Read: `.claude/kb/nextjs/index.md` — Scan topic headings
...
**Process:**
1. Read `.claude/kb/react/patterns/component-composition.md`
...
**Process:**
1. Read `.claude/kb/react/concepts/hooks-patterns.md`
2. Read `.claude/kb/react/concepts/state-management.md` if complex state
...
**Process:**
1. Read `.claude/kb/react/patterns/data-fetching.md`
2. Read `.claude/kb/nextjs/patterns/api-routes.md` if Next.js
...
**Process:**
1. Read `.claude/kb/react/patterns/form-handling.md`
