...
**Process:**
1. Read `.claude/kb/nextjs/concepts/rendering-strategies.md`
...
**Process:**
1. Read `.claude/kb/frontend-patterns/concepts/performance.md`
2. Read `.claude/kb/nextjs/concepts/caching.md`
...
**Process:**
1. Read `.claude/kb/frontend-patterns/concepts/project-structure.md`
...
**Process:**
1. Read `.claude/kb/nextjs/concepts/caching.md`
...
**Process:**
1. Read `.claude/kb/nextjs/patterns/api-routes.md`
2. Read `.claude/kb/nextjs/concepts/middleware.md`
