...
- Read: `.claude/kb/accessibility/index.md` — Scan topic headings
...
**Process:**
1. Read `.claude/kb/accessibility/concepts/wcag-guidelines.md`
...
**Process:**
1. Read `.claude/kb/accessibility/concepts/keyboard-navigation.md`
...
**Process:**
1. Read `.claude/kb/accessibility/patterns/form-accessibility.md`
...
**Process:**
1. Read `.claude/kb/accessibility/patterns/modal-dialog.md`
...
**Process:**
1. Read `.claude/kb/accessibility/patterns/table-accessibility.md`
