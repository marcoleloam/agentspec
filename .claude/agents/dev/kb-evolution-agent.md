...
│                                                                      │
│  1. KB MANIFEST                                                     │
│     └─ Read: .claude/kb/_index.yaml → Domain registry               │
│     └─ Glob: .claude/kb/{domain}/**/*.md → Current content          │
│     └─ Read: .claude/kb/_templates/ → File format templates         │
│                                                                      │
...
5. **Update `log.md`** — Append entry to `.claude/kb/{domain}/log.md` with:
...
6. **Update `log.md`** — Append lint entry to `.claude/kb/{domain}/log.md`
