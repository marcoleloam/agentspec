...
```python
def estimate_cost(num_documents: int, avg_pages: int = 2) -> dict:
    """Estimate cost for document processing batch."""
    ...
    total_input = num_documents * (avg_pages * tokens_per_page + prompt_tokens)
    total_output = num_documents * output_tokens
...
# {'documents': 1000, 'input_tokens': 1016000, 'output_tokens': 1000000,
...
| ---------- | --------------------- | -------------------------- |
| 100 documents | $0.08 | $0.05 |
| 1,000 documents | $0.75 | $0.50 |
| 10,000 documents | $7.50 | $5.00 |
